...
>
> Les mentions placées entre crochets doivent être complétées par l’organisme qui exploite effectivement le portail. Les bases légales, les destinataires, les transferts et les durées doivent être vérifiés au regard de son organisation, de ses prestataires et du droit sectoriel qui lui est applicable. Ce document ne doit pas être publié tant qu’une mention obligatoire reste incomplète.
...
- **Organisme :** [NOM OU DÉNOMINATION SOCIALE] ;
- **Forme juridique :** [FORME JURIDIQUE OU TYPE D’ORGANISME] ;
- **Adresse :** [ADRESSE POSTALE COMPLÈTE] ;
- **Adresse électronique :** [ADRESSE ÉLECTRONIQUE DE CONTACT RGPD] ;
- **Téléphone :** [NUMÉRO DE TÉLÉPHONE].

Le cas échéant, son délégué ou sa déléguée à la protection des données peut être contacté :

- **Délégué à la protection des données :** [NOM OU FONCTION] ;
- **Adresse électronique :** [ADRESSE ÉLECTRONIQUE DU DPO] ;
...
Si une campagne est organisée conjointement avec une autre structure, son rôle et la répartition des responsabilités doivent être précisés ici ou dans l’information propre à la campagne :

- **Responsable conjoint ou partenaire concerné :** [NOM, COORDONNÉES ET RÉPARTITION DES RESPONSABILITÉS, LE CAS ÉCHÉANT].
...
- les systèmes externes connectés par une API ou un webhook lorsque l’organisme a activé une telle intégration : [LISTE DES INTÉGRATIONS, FINALITÉS ET DESTINATAIRES].
...
| Signalements, incidents et actions de modération | Pendant leur traitement, puis [DURÉE À DÉFINIR SELON LES DÉLAIS DE RECOURS ET DE PRESCRIPTION] |
| Preuves d’acceptation, d’autorisation et de retrait | Pendant la relation, puis [DURÉE DE PREUVE À DÉFINIR] |
| Messages et pièces jointes envoyés au support | Non stockés dans les tables ou documents du module ; conservation dans la messagerie destinataire selon [POLITIQUE DE MESSAGERIE À PRÉCISER] |
...
| Fiche d’adhérent, cotisations et pièces administratives éventuelles | Selon le cycle propre à l’adhésion et les obligations comptables, fiscales ou associatives de l’organisme : [DURÉES À PRÉCISER] |
| Sauvegardes et journaux d’infrastructure | [DURÉES ET CYCLE D’ÉCRASEMENT À PRÉCISER] |
...
- **Hébergement principal :** [PAYS ET PRESTATAIRE] ;
- **Messagerie :** [PAYS ET PRESTATAIRE] ;
- **Sauvegardes :** [PAYS ET PRESTATAIRE] ;
- **Autres prestataires :** [PAYS, PRESTATAIRE ET SERVICE].

Si un transfert existe, préciser ici sa base et les garanties applicables : [DÉCISION D’ADÉQUATION, CLAUSES CONTRACTUELLES TYPES, RÈGLES D’ENTREPRISE CONTRAIGNANTES OU AUTRE GARANTIE, AINSI QUE LE MOYEN D’EN OBTENIR UNE COPIE].
...
- par courrier électronique à [ADRESSE ÉLECTRONIQUE RGPD OU DPO] ;
- par courrier postal à [ADRESSE POSTALE RGPD OU DPO].
