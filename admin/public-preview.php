...
print '<a class="eh-button eh-button-need" href="#preview-requests">'.$langs->trans('NeedAccommodationCta').'</a>';
print '<a class="eh-button eh-button-offer" href="#preview-offers">'.$langs->trans('OfferAccommodationCta').'</a>';
